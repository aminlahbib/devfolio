    ...
    <div className="min-h-screen pt-28 pb-20 px-6">
      ...
      >
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl leading-relaxed">
            A selection of projects I've built, from microservices platforms to real-time systems. 
            Each project demonstrates different aspects of software engineering.
          </p>
          ...
          {status === LoadStatus.SUCCESS && (
            <div className="flex items-center gap-6 mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-800">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-sm text-neutral-500 dark:text-neutral-400">Projects</span>
              </div>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-sm text-neutral-500 dark:text-neutral-400">Technologies</span>
              </div>
              <div className="w-px h-6 bg-neutral-200 dark:bg-neutral-800" />
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-semibold text-neutral-900 dark:text-white">{stats.featured}</span>
                <span className="text-sm text-neutral-500 dark:text-neutral-400">Featured</span>
              </div>
            </div>
          )}
      </motion.div>
