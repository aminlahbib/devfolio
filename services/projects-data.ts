...
Infrastructure is fully codified using Terraform for GCP resources (GKE, Cloud SQL, Pub/Sub, Secret Manager) and Helm charts for Kubernetes deployments, with Docker Compose for local development parity.`,
    ...
    category: 'Full Stack',
    imageUrl: '/images/projects/cloud-secrets-manager/main.jpg',
    images: [
      '/images/projects/cloud-secrets-manager/1.jpg',
      '/images/projects/cloud-secrets-manager/2.jpg',
      '/images/projects/cloud-secrets-manager/3.jpg',
      '/images/projects/cloud-secrets-manager/4.jpg'
    ],
...
The frontend is intentionally built with vanilla JavaScript (ES6+) and Web Audio API for audio visualizations, demonstrating that complex real-time applications don't require heavy frameworks.`,
    ...
    category: 'Full Stack',
    imageUrl: '/images/projects/real-time-ai-tts-system/main.jpg',
    images: [
      '/images/projects/real-time-ai-tts-system/1.jpg',
      '/images/projects/real-time-ai-tts-system/2.jpg',
      '/images/projects/real-time-ai-tts-system/3.jpg'
    ],
...
Comprehensive documentation covers the entire deployment workflow: local development with Docker Compose, deployment to Minikube for testing, and guides for production deployment to AWS EKS or GCP GKE.`,
    ...
    category: 'Full Stack',
    imageUrl: '/images/projects/equipment-management-system/main.jpg',
    images: [
      '/images/projects/equipment-management-system/1.jpg',
      '/images/projects/equipment-management-system/2.jpg',
      '/images/projects/equipment-management-system/3.jpg'
    ],
